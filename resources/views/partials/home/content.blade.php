      ...
      <div class="w-2/3 lg:w-1/4 xl:w-1/5 mx-auto lg:mx-0">
        <div class="p-6">
          <div class="mb-5 px-6 hidden md:block">
            <a href="<?php the_field('chow_now'); ?>" class="block aspect-ratio group aspect-ratio--1x1 bg-white rounded-full transition-all duration-200 ease-in-out hover:bg-green-darker hover:scale-105 hover:text-white">
